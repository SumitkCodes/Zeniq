    ...
    <aside className={cn(
      ...
      <div className="flex h-16 items-center justify-center border-b border-sidebar-border">
        <div className={cn(
          ...
          <img src="/zeniq-uploads/f1df4580-0247-4c53-9897-e18fbba175db.png" alt="Zeniq" className="w-8 h-8" />
          <h2 className="font-heading font-bold text-xl tracking-wider neon-text">
            ZENIQ
          </h2>
        </div>
          ...
          {navItems.map((item, index) => {
            ...
            return (
              <Link
                ...
                to={item.href}
                className={cn(
                  "flex items-center gap-3 rounded-xl px-3 py-3 transition-all duration-300 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:neon-glow",
                  isActive ? "bg-primary/20 text-primary neon-glow border border-primary/30" : "text-sidebar-foreground",
